...
- **2026-07-11** — Web PWA install: Personal → App & Legal → Install App; `web/pwa_install.js` + `PwaInstallService` (`beforeinstallprompt` on Chrome/Edge, Safari instructions on iOS).
