...
class AttendingSundayServicePage extends StatefulWidget {
  const AttendingSundayServicePage({super.key});

  @override
  State<AttendingSundayServicePage> createState() =>
      _AttendingSundayServicePageState();
}

class _AttendingSundayServicePageState
    extends State<AttendingSundayServicePage> {
