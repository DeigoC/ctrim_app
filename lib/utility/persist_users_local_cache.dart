...
Future<void> persistUsersLocalCache(Iterable<User> users, {int? lastUpdate}) async {
  final packageInfo = await PackageInfo.fromPlatform();
  final resolvedLastUpdate =
      lastUpdate ?? await IDTrackerDBManager().fetchLastUpdate(IDTrackerDBManager.usersDoc);
