...
| **Attendance** | Who is (or was) attending — registered people or **placeholders**. Interested people can be promoted to attending; expected people can be checked off. **Post contributors** (and the author) manage the lists; they stay editable after the event. When you **create** a post dated **before today**, the draft already offers **Select who attended** so you can record who was there before the post is saved. |
