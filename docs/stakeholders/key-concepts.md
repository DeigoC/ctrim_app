...
| **Team tag** | A department label on a person and on programme slots (Worship, Technical, and similar), with an optional short description. Anyone can open **Team tags** under Personal → **For you**. Area admins can hide the label from **guests**. The person and the schedule line still show. |
