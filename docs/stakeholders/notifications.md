...
When a notification arrives on this device, tapping it (or **View post** / **View page** in the in-app banner) opens the related post or teaching page. Post links work for guests as well as signed-in members.
