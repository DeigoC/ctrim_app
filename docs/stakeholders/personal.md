...
- **For you → Team tags** — what each team is for. Open to guests and signed-in people. Tap a team to read its short description. Area admins edit tags from the same page (add, reorder, hide from guests). Tags hidden from guests do not appear in this list for guests.
...
Step-by-step notes: [Platforms](platforms.md).

## Slide Deck Utils

**Settings → Slide Deck Utils** opens a **separate** helper site for creating slides or extracting text from PDF/PPTX. It is useful for speakers and leaders preparing talks — it is not part of the community bulletin itself.
